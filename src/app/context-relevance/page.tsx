...
export default function ContextRelevancePage() {
  ...
  const definition = "Measures how much of the provided context was actually used to formulate the answer. A low score might indicate that the context was not very useful for the given question.";

  return (
    <MetricDetailPage metricName="Context Relevance" score={metrics.contextRelevance} definition={definition}>
