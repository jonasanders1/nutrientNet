...
import { AnswerRelevanceDetail } from '@/components/answer-relevance-detail';
import { Card, CardHeader, CardTitle, CardContent } from '@/components/ui/card';
import { Scale } from 'lucide-react';
import Link from 'next/link';
import { Button } from '@/components/ui/button';

export default function AnswerRelevancePage() {
  ...
  const definition = "Measures how well the generated answer addresses the user's original question. It uses generated questions from the answer to check their similarity to the original question.";

  return (
    <MetricDetailPage metricName="Answer Relevance" score={metrics.answerRelevance} definition={definition}>
      <AnswerRelevanceDetail details={metrics.details} />
    </MetricDetailPage>
  );
}
